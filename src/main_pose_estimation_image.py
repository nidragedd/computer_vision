...
from src.pose.pose_detection import HumanPoseDetector
...
if __name__ == '__main__':
    ...
    pose_detector = HumanPoseDetector()
    ...
    for model_name, pose_model in config.pgconf.get_pose_estimation_models().items():
        ...
        image = pose_detector.detect_with_model(pose_model, image, vars(args)["confidence"])
